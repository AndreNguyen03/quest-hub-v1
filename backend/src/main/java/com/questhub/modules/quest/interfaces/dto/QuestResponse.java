...
public record QuestResponse(
  ...
  public record ChapterResponse(
    ...
    public static ChapterResponse from(com.questhub.modules.quest.domain.quest.Chapter chapter) {
  ...
  public record TaskResponse(
    ...
    public static TaskResponse from(com.questhub.modules.quest.domain.quest.Task task) {
  ...
  public record ResourceResponse(
    ...
    public static ResourceResponse from(com.questhub.modules.quest.domain.quest.Resource resource) {
