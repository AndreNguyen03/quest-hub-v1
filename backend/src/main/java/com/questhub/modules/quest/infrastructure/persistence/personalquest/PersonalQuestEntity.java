...
public class PersonalQuestEntity {
  ...
  @OrderBy("position")
  private List<PersonalChapterEntity> chapters = new ArrayList<>();

  protected PersonalQuestEntity() {}

  public PersonalQuestEntity(
      UUID id,
      UUID userId,
      UUID questId,
      UUID learningPathId,
      ...
      Instant updatedAt,
      Instant completedAt,
      List<PersonalChapterEntity> chapters) {
    this.id = id;
    this.userId = userId;
  ...
  public List<PersonalChapterEntity> getChapters() {
    return chapters;
  }
}