...
public class PersonalTaskJpaEntity {
  ...
  private PersonalChapterJpaEntity personalChapter;
  ...
  protected PersonalTaskJpaEntity() {}

  public PersonalTaskJpaEntity(
      UUID id,
      UUID sourceTaskId,
      TaskType type,
      String title,
  ...
  public void setPersonalChapter(PersonalChapterJpaEntity personalChapter) {
