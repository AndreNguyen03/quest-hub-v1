...
import com.questhub.modules.quest.application.command.CompleteTaskCommand;
...
import com.questhub.modules.quest.application.query.GetPersonalQuestQuery;
import com.questhub.modules.quest.application.query.GetPersonalQuestsQuery;
import com.questhub.modules.quest.application.query.GetQuizHistoryQuery;
...
import com.questhub.modules.quest.application.dto.PersonalQuestResponse;
...
public class PersonalQuestController {
  ...
  public ResponseEntity<ApiResponse<List<PersonalQuestResponse>>> list() {
    List<PersonalQuestResponse> responses =
        GetPersonalQuestsQuery.list(currentUserId()).stream()
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> get(@PathVariable UUID id) {
    PersonalQuest personalQuest = GetPersonalQuestQuery.get(id, currentUserId());
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> completeTask(
      @PathVariable UUID pqId, @PathVariable UUID ptId, @RequestBody(required = false) CompleteTaskCommand request) {
  ...
  public ResponseEntity<ApiResponse<SubmitQuizResponse>> submitQuiz(
      ...
      @RequestBody(required = false) SubmitQuizCommand request) {
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> addChapter(
      @PathVariable UUID pqId, @RequestBody AddChapterCommand request) {
    PersonalQuest quest =
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> addTask(
      ...
      @RequestBody AddTaskCommand request) {
    PersonalQuest quest =
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> reorderChapters(
      @PathVariable UUID pqId, @RequestBody ReorderChaptersCommand request) {
    PersonalQuest quest =
  ...
  public ResponseEntity<ApiResponse<PersonalQuestResponse>> reorderTasks(
      @PathVariable UUID pqId,
      @PathVariable UUID chapterId,
      @RequestBody ReorderTasksCommand request) {
    PersonalQuest quest =
