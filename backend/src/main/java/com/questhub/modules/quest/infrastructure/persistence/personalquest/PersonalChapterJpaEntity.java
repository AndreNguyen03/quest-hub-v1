...
public class PersonalChapterJpaEntity {
  ...
  private PersonalQuestJpaEntity personalQuest;
  ...
  @OrderBy("order")
  private List<PersonalTaskJpaEntity> tasks = new ArrayList<>();

  protected PersonalChapterJpaEntity() {}

  public PersonalChapterJpaEntity(
      UUID id,
      ...
      Instant createdAt,
      Instant updatedAt,
      List<PersonalTaskJpaEntity> tasks) {
    this.id = id;
  ...
  public void setPersonalQuest(PersonalQuestJpaEntity personalQuest) {
  ...
  public List<PersonalTaskJpaEntity> getTasks() {
    return tasks;
  }
}
